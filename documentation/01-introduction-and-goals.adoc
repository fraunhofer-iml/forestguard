...
image:images/introduction-and-goals/se-big-picture.png[se-big-picture]
...
image:images/introduction-and-goals/overview-blockchain-broker.png[overview-blockchain-broker]
