import { FarmerCreateDto, FarmerDto, TAuthenticatedUser, UserDto, UserUpdateDto } from '@forest-guard/api-interfaces';
...
export class UserController {
  ...
  createFarmer(@Body() dto: FarmerCreateDto, @AuthenticatedUser() user: TAuthenticatedUser): Promise<FarmerDto> {
